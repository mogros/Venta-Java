...
public class ProductoController {
	...
	@PostMapping
	public ResponseEntity<Producto> registrar(@Valid @RequestBody Producto m) throws Exception {
		//return new ResponseEntity<>(service.registrar(obj), HttpStatus.CREATED); //201 		
		 
		Producto obj = service.registrar(m);
		//localhost:8080/producto/1
	...
	public EntityModel<Producto> listarHateoasPorId(@PathVariable("id") Integer id) throws Exception{
		...
		//localhost:8080/producto/hateoas/1
